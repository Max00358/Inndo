...
import com.laioffer.inndo.location.GeocodingService;
...
import com.laioffer.inndo.storage.ImageStorageService;
...
public class ListingService {
    ...
    public List<ListingDto> search(
        ...
        if(guestNum <= 0 || guestNum > 16) {
            throw new InvalidListingSearchException("Guest number must be within range (0,16].");
        }
